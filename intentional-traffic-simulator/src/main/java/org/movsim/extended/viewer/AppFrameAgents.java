...
public class AppFrameAgents extends JFrame {
    ...
    public AppFrameAgents(ResourceBundle resourceBundle, ProjectMetaData projectMetaData, Properties properties) {
        
        SwingHelper.activateWindowClosingAndSystemExitButton(this);

        final Simulator simulator = new SimulatorExtended();
        initLookAndFeel();
